    ...
    getTitle() {
        return (
            <div className="newItem-title">
                <a href={this.props.item.url ? this.props.item.url : 'https://news.ycombinator.com/item?id=' + this.props.item.id} className="newsItem-titleLink">{this.props.item.title}</a>
                {
